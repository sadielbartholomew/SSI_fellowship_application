...
#+REVEAL_HTML: <div class="column" style="float:right; width:40%;">
#+REVEAL_HTML: <img src="./media/videos/rotation_of_fractioned_circles_uniform.gif" style="box-shadow: rgba(0, 0, 0, 0.35) 0px 5px 15px;" />
#+REVEAL_HTML: </div>
...
#+REVEAL_HTML:<img src="./media/screenshots/tweet_le_parc.png" width="150%" height="150%" style="box-shadow: rgba(0, 0, 0, 0.35) 0px 5px 15px;">
 #+REVEAL_HTML: </div>

#+REVEAL_HTML: <div class="column" style="float:right; width:50%">
#+REVEAL_HTML:<img src="./media/screenshots/tweet_hacktoberfest.png" width="150%" height="150%" style="box-shadow: rgba(0, 0, 0, 0.35) 0px 5px 15px;">
 #+REVEAL_HTML: </div>
